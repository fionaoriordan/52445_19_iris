...
1. However, when we run classiris.py for sepal-width and again for sepal-length, we notice that no such distinction exists. The measurements for all three classes overlap. ![Hist_sepal-width.png](https://github.com/fionaoriordan/52445_19_iris/blob/master/Hist_sepal-width.png)
