...
# See the first 5 (5 is the default)rows of the data set, print to the screen
print(iris.head())

# Using to_csv to write the first 5 rows to an output file with  separator ',' to separate the data into columns
iris.head().to_csv("head5irisout.csv", sep=',')

# See the first 5 rows (5 is the default) of the data set, print to the screen
print(iris.tail())

# Using to_csv to write the first 5 rows to an output file with  separator ',' to separate the data into columns
iris.tail().to_csv("tail5irisout.csv", sep=',')
